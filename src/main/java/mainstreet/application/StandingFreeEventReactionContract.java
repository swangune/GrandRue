...
public final class StandingFreeEventReactionContract {
    ...
    public static final EventReactionContractAffinity AFFINITY =
            new EventReactionContractAffinity(IDENTITY, "standing-free-event-reactions@1");
    public static final EventReactionContractDefinition DEFINITION = new EventReactionContractDefinition(
            IDENTITY, MerchantAccountEstablishedEventContract.AFFINITY,
            ...
            new EventReactionTargetReference("commercial", "standing-free.establish-from-merchant-establishment"),
            ...
            Set.of("MS-PROT-056-v1.6/3:merchant-scope",
    ...
    public static String downstreamLogicalIntentReference(
        ...
        return DOWNSTREAM_INTENT_PREFIX + occurrence.fact().establishmentIdentity();
    }
}
