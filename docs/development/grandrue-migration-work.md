...
```yaml
coverage:
  completed_leaf_records_through: GR-REN-02-01X12
  completed_leaf_count: 35
  remaining_expansion_node: GR-REN-02-01X+
  remaining_enumeration: INCOMPLETE
  unclassified: UNKNOWN_UNTIL_ENUMERATION
...
last_completed_leaf: GR-REN-02-01X12
last_code_commit: 3ca2a6b3cb393eddca33c2350275e8abb37e6873
