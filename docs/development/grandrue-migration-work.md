...
```yaml
coverage:
  completed_leaf_records_through: GR-REN-02-01X20
  completed_leaf_count: 43
  remaining_expansion_node: GR-REN-02-01X+
  remaining_enumeration: INCOMPLETE
  unclassified: UNKNOWN_UNTIL_ENUMERATION
...
last_completed_leaf: GR-REN-02-01X20
last_code_commit: 1cd5fec356273b4ea26be2d6625620c89069ef1d
